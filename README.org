...
- Runs open source pre-trained LLM locally without the need for an API key or internet connection.
  - [[https://huggingface.co/docs/transformers/en/model_doc/gpt2][GPT2 (1.5B)]] for English
  - [[https://huggingface.co/bigscience/bloom][Bloom (560M)]] for 46 languages
  - [[https://huggingface.co/facebook/xglm-564M][XGLM (564M)]] for 30 languages
